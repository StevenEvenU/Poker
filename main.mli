...
(** Updates the bets array that keeps track of each 
    persons bet in a round of betting *)
...
val rec_betting_round : State.state -> State.players array ref -> int array -> State.players -> int -> int
